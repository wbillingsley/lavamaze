...
object CodeRunner {
   ...
   * @param asyncifyCalls strings that should have "await " put in front of them. This can be useful if you have code that you
   ...
   * @return
   */
  def asyncCall(thisVal: js.Any = new js.Object(), args:Seq[(String, js.Any)] = Seq.empty, asyncifyCalls:Boolean = true, code:String = ""):js.Dynamic = {
    asyncBind(thisVal, args, asyncifyCalls, code)()
  }
  ...
  def asyncify(code:String):String = {
    val asyncifyjs = js.Dynamic.global.asyncify.asyncify.asInstanceOf[js.Function1[String, String]]
    asyncifyjs(code)
  }
   ...
   * @return
   */
  def asyncBind(thisVal: js.Any = new js.Object(), args:Seq[(String, js.Any)] = Seq.empty, asyncifyCalls:Boolean = true, code:String = ""):js.Dynamic = {
    ...
    val modifiedCode:js.Any = if (asyncifyCalls) code else asyncify(code)
...
abstract class CodeRunner(rpcs:Map[String, js.Function], bindings:Map[String, js.Any], asyncifyCalls:Boolean) {
    ...
    try {
      val message = js.Dictionary[js.Any](
        ...
        "payload" -> js.Dictionary[js.Any](
          ...
          "code" -> (if (asyncifyCalls) CodeRunner.asyncify(code) else code)
        )
      )
